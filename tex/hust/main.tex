\documentclass[format=draft,degree=master,language=chinese]{hustthesis} %format=final
...
generate redundant encrypted data units, after erasing the metadata like hash information on the key disk or erasing a certain
amount of encrypted data, the original data can no longer be recovered. Therefore, the proposol ensures the security
of data.


Through simulation experiments, we verified the effectiveness of secure deletion proposed in the dissertation, that 
...
informations of the original file to ensure data security, compared to the way that delete the encrypted data stored in flash memory, 
...
%% 正文
\include{Chapter1/cp1}
\include{Chapter2/cp2}
\include{Chapter3/cp3}
\include{Chapter4/cp4}
\include{Chapter5/cp5}
%\include{Pics/pic}
